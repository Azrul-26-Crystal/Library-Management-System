...
const getBookHandler = asyncHandler(async (req,res) =>{
        const books = await findBookById(req.params.id)
        res.json(books)
})
...
module.exports = {createBookHandler,getManyBooksHandler,getBookHandler,deleteBookHandler,updateBookHandler,bookLendingHandler}